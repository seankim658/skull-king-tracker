...
export function ActiveSessions() {
  ...
  const tooltipContent = (
    <>
      A <strong>Session</strong> is a collection of multiple games, perfect for
      tracking a group of games. You can start a new game within a session here,
      or tap a session to see more details.
    </>
  );
